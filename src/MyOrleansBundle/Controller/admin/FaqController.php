...
class FaqController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        $faqs = $em->getRepository('MyOrleansBundle:Faq')->findBy([], ['tri'=>'ASC']);
    ...
    {
        $faq = new Faq();
        $form = $this->createForm('MyOrleansBundle\Form\FaqType', $faq);
    ...
    {
        $deleteForm = $this->createDeleteForm($faq);
        $editForm = $this->createForm('MyOrleansBundle\Form\FaqType', $faq);
