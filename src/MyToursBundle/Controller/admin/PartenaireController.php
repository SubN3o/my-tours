...
class PartenaireController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        $partenaires = $em->getRepository('MyToursBundle:Partenaire')->findBy([], ['tri'=>'ASC']);
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('MyToursBundle\Form\PartenaireType', $partenaire);
    ...
    {
        $deleteForm = $this->createDeleteForm($partenaire);
        $editForm = $this->createForm('MyToursBundle\Form\PartenaireType', $partenaire);
