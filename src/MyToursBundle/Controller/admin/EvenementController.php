...
class EvenementController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        $evenements = $em->getRepository('MyToursBundle:Evenement')->findBy([], ['dateDebut'=>'ASC']);
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('MyToursBundle\Form\EvenementType', $evenement);
    ...
    public function editAction(Request $request, Evenement $evenement)
    {
        ...
        $editForm = $this->createForm('MyToursBundle\Form\EvenementType', $evenement);
     ...
     * @ParamConverter("evenement", class="MyToursBundle:Evenement", options={"id" = "id"})
