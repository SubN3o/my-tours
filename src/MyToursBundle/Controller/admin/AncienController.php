...
use MyToursBundle\Form\AncienType;
...
class AncienController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        $anciens = $em->getRepository('MyToursBundle:Ancien')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('MyToursBundle\Form\AncienType', $ancien);
     ...
     * @ParamConverter("ancien", class="MyToursBundle:Ancien", options={"id" = "id"})
