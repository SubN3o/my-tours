...
class PackController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $packs = $em->getRepository('MyToursBundle:Pack')->findBy([], ['tri'=>'ASC']);
    ...
    {
        $pack = new Pack();
        $form = $this->createForm('MyToursBundle\Form\PackType', $pack);
    ...
    {
        $deleteForm = $this->createDeleteForm($pack);
        $editForm = $this->createForm('MyToursBundle\Form\PackType', $pack);
