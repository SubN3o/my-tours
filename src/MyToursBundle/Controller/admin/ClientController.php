...
class ClientController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        $clients = $em->getRepository('MyToursBundle:Client')->findBy([],['date'=>'DESC']);
    ...
    {
        $client = new Client();
        $form = $this->createForm('MyToursBundle\Form\ClientType', $client);
    ...
    {
        $deleteForm = $this->createDeleteForm($client);
        $editForm = $this->createForm('MyToursBundle\Form\ClientType', $client);
