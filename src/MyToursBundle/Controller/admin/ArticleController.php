...
use MyToursBundle\Form\ArticleType;
...
class ArticleController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        $articles = $em->getRepository('MyToursBundle:Article')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('MyToursBundle\Form\ArticleType', $article);
     ...
     * @ParamConverter("article", class="MyToursBundle:Article", options={"id" = "id"})
     ...
     * @ParamConverter("article", class="MyToursBundle:Article", options={"id" = "id"})
     * @ParamConverter("tag", class="MyToursBundle:Tag", options={"id" = "tag_id"})
     * @Method({"GET", "POST"})
     */
