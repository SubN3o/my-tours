...
class RealisationController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        $realisations = $em->getRepository('MyToursBundle:Realisation')->findBy([], ['tri'=>'ASC']);
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('MyToursBundle\Form\RealisationType', $realisation);
    ...
    {
        $deleteForm = $this->createDeleteForm($realisation);
        $editForm = $this->createForm('MyToursBundle\Form\RealisationType', $realisation);
