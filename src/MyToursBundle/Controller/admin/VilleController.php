...
class VilleController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        $villes = $em->getRepository('MyToursBundle:Ville')->findAll();
    ...
    {
        $ville = new Ville();
        $form = $this->createForm('MyToursBundle\Form\VilleType', $ville);
    ...
    {
        $deleteForm = $this->createDeleteForm($ville);
        $editForm = $this->createForm('MyToursBundle\Form\VilleType', $ville);
