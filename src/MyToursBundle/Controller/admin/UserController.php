...
class UserController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $users = $em->getRepository('MyToursBundle:User')->findAll();
    ...
    {
        $user = new User();
        $form = $this->createForm('MyToursBundle\Form\UserType', $user);
    ...
    {
        $deleteForm = $this->createDeleteForm($user);
        $editForm = $this->createForm('MyToursBundle\Form\UserType', $user);
