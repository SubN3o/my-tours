...
class TemoignageController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        $temoignages = $em->getRepository('MyToursBundle:Temoignage')->findBy([], ['tri'=>'ASC']);
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('MyToursBundle\Form\TemoignageType', $temoignage);
    ...
    {
        $deleteForm = $this->createDeleteForm($temoignage);
        $editForm = $this->createForm('MyToursBundle\Form\TemoignageType', $temoignage);
