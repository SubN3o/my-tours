...
use MyToursBundle\Form\LocationType;
...
class LocationController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        $locations = $em->getRepository('MyToursBundle:Location')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('MyToursBundle\Form\LocationType', $location);
     ...
     * @ParamConverter("location", class="MyToursBundle:Location", options={"id" = "id"})
