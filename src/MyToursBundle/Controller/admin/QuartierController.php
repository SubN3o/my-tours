...
class QuartierController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $quartiers = $em->getRepository('MyToursBundle:Quartier')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('MyToursBundle\Form\QuartierType', $quartier);
    ...
    {
        $deleteForm = $this->createDeleteForm($quartier);
        $editForm = $this->createForm('MyToursBundle\Form\QuartierType', $quartier);
