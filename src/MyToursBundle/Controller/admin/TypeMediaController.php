...
class TypeMediaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $typeMedia = $em->getRepository('MyToursBundle:TypeMedia')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('MyToursBundle\Form\TypeMediaType', $typeMedia);
    ...
    {
        $deleteForm = $this->createDeleteForm($typeMedia);
        $editForm = $this->createForm('MyToursBundle\Form\TypeMediaType', $typeMedia);
