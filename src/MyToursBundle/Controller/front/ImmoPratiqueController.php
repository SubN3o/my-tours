...
class ImmoPratiqueController extends Controller
{
    ...
    public function immoPratiqueAction(FormulaireContact $formulaireContact, Request $request)
    {
        ...
        $articlesSearch = $this->createForm('MyToursBundle\Form\SearchArticleType');
        ...
        return $this->render('MyToursBundle::immoPratique.html.twig', [
            'articles' => $articles,
     ...
     * @ParamConverter("article", class="MyToursBundle:Article", options={"slug" = "slug"})
     */
    public function afficherArticleAction(Request $request, Article $article, FormulaireContact $formulaireContact)
    {
        ...
        return $this->render('MyToursBundle::article.html.twig',[
            'article' => $article,
            'telephone_number' => $telephoneNumber,
