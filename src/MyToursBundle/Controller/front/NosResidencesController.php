...
use MyToursBundle\Service\AutocompleteGenerator;
...
use MyToursBundle\Repository\ArticleRepository;
...
class NosResidencesController extends Controller
{
    ...
    public function nosResidencesAction(Request $request, FormulaireContact $formulaireContact)
    {
        ...
        $simpleSearch = $this->createForm('MyToursBundle\Form\SimpleSearchType', null, ['action' => $this->generateUrl('nosresidences')]);
        ...
        $completeSearch = $this->createForm('MyToursBundle\Form\CompleteSearchType', ['ville'=>$selectedVille, 'type'=>$selectedType], ['action' => $this->generateUrl('nosresidences-search')]);
        ...
        return $this->render('MyToursBundle::nosResidences.html.twig', [
    ...
    public function completeSearchAction(Request $request, FormulaireContact $formulaireContact)
    {
        ...
        $completeSearch = $this->createForm('MyToursBundle\Form\CompleteSearchType');
        $completeSearch->handleRequest($request);
