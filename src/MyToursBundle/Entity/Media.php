 ...
 * @ORM\Entity(repositoryClass="MyToursBundle\Repository\MediaRepository")
 * @Vich\Uploadable
 */
class Media
{
     ...
     * Get partenaire
     *
     * @return \MyToursBundle\Entity\Partenaire
     */
     ...
     * Set partenaire
     *
     * @param \MyToursBundle\Entity\Partenaire $partenaire
     *
     * @return Media
     */
    public function setPartenaire(\MyToursBundle\Entity\Partenaire $partenaire = null)
    {
     ...
     * Get realisation
     *
     * @return \MyToursBundle\Entity\Realisation
     */
     ...
     * Set realisation
     *
     * @param \MyToursBundle\Entity\Realisation $realisation
     *
     * @return Media
     */
    public function setRealisation(\MyToursBundle\Entity\Realisation $realisation = null)
    {
     ...
     * Set pack
     *
     * @param \MyToursBundle\Entity\Pack $pack
     *
     * @return Media
     */
    public function setPack(\MyToursBundle\Entity\Pack $pack = null)
    {
        $this->pack = $pack;
     ...
     * Get pack
     *
     * @return \MyToursBundle\Entity\Pack
     */
     ...
     * Add ancien
     *
     * @param \MyToursBundle\Entity\Ancien $ancien
     *
     * @return Media
     */
    public function addAncien(\MyToursBundle\Entity\Ancien $ancien)
    {
        $this->anciens[] = $ancien;
     ...
     * @param \MyToursBundle\Entity\Ancien $ancien
     */
    public function removeAncien(\MyToursBundle\Entity\Ancien $ancien)
    {
     ...
     * Add location
     *
     * @param \MyToursBundle\Entity\Location $location
     *
     * @return Media
     */
    public function addLocation(\MyToursBundle\Entity\Location $location)
    {
     ...
     * @param \MyToursBundle\Entity\Location $location
     */
    public function removeLocation(\MyToursBundle\Entity\Location $location)
    {
